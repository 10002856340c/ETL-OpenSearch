...
class Main:
    def __init__(self):
        ...
        self.db_pass_moodle = int(os.environ['db_pass_moodle'])
        self.db_name_moodle_plug = int(os.environ['db_name_moodle_plug'])
        self.db_name_moodle_adminhr = int(os.environ['db_name_moodle_adminhr'])
        self.db_name_moodle_learning = int(os.environ['db_name_moodle_learning'])
