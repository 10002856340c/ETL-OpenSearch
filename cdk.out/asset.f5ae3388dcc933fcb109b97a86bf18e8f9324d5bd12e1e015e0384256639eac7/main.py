...
class Main:
    def __init__(self):
        ...
        self.rds_host_moodle = os.environ['RDS_HOST_MOODLE']
        self.db_user_moodle = os.environ['DB_USER_MODEL']
        self.db_pass_moodle = os.environ['DB_PSS_MOODLE']
        self.db_name_moodle = os.environ['DB_NAME_MOODLE']
        self.db_port_moodle = int(os.environ['DB_PORT_MOODLE'])
